...
#: parse user input
parser = argparse.ArgumentParser(prog='is_valid_data_table_yaml', description="Determines if a yaml data_table is valid. More details on the yaml format can be found in https://github.com/NOAA-GFDL/FMS/tree/main/data_override")
